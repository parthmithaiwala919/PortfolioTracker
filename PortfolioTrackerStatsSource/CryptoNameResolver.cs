...
namespace PortfolioTrackerStatsSource
{
    ...
    public class CryptocurrencyResolverImpl : ICryptocurrencyResolver
    {
        ...
        private IPortfolioTrackerStatsSource _PortfolioTrackerStatsSource;
        
        // a dictionary mapping symbols to cryptocurrencies
        private Dictionary<String, Cryptocurrency> _nameToCryptocurrencyDictionary;

        /// <param name="PortfolioTrackerStatsSource">PortfolioTrackerStatsSource interface to be used</param>
        public CryptocurrencyResolverImpl(IPortfolioTrackerStatsSource PortfolioTrackerStatsSource)
        {
            _PortfolioTrackerStatsSource = PortfolioTrackerStatsSource;
        }
        ...
        public async Task Refresh()
        {
            ...
            (await _PortfolioTrackerStatsSource.GetAvailableCryptocurrencies())
